        ...
        <div className="text-right">
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[300px] py-4 relative">
              ...
              <div className="py-4">
                <form>
                  <input type="email" placeholder="Enter your email" className="bg-primary border border-input p-2 mr-2 w-full shadow-xl md:w-auto"/>
                  <button className="bg-button text-btnTxt px-4 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl md:w-auto my-2">Sign Up</button>
                </form>
              </div>
